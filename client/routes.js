...
const Toaster = React.lazy(() => import('./admin/views/notifications/toaster/Toaster'));
...
const BasicForms = React.lazy(() => import('./admin/views/base/forms/BasicForms'));

const Jumbotrons = React.lazy(() => import('./admin/views/base/jumbotrons/Jumbotrons'));
const ListGroups = React.lazy(() => import('./admin/views/base/list-groups/ListGroups'));
const Navbars = React.lazy(() => import('./admin/views/base/navbars/Navbars'));
const Navs = React.lazy(() => import('./admin/views/base/navs/Navs'));
const Paginations = React.lazy(() => import('./admin/views/base/paginations/Pagnations'));
const Popovers = React.lazy(() => import('./admin/views/base/popovers/Popovers'));
const ProgressBar = React.lazy(() => import('./admin/views/base/progress-bar/ProgressBar'));
const Switches = React.lazy(() => import('./admin/views/base/switches/Switches'));
...
const BrandButtons = React.lazy(() => import('./admin/views/buttons/brand-buttons/BrandButtons'));
const ButtonDropdowns = React.lazy(() => import('./admin/views/buttons/button-dropdowns/ButtonDropdowns'));
